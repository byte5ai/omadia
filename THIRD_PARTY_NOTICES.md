...
`middleware` and `web-dev` workspaces — the upstream projects retain their
...
| `web-dev` | 584 | 575 | 4 (LGPL ×1, MPL ×3) | 4 (CC0, CC-BY-4.0, MIT-0, BlueOak) | 2 |
...
web-dev (Next.js Image component runtime).
...
|---|---|---|---|
| `axe-core` | MPL-2.0 | <https://github.com/dequelabs/axe-core> | web-dev (a11y dev tooling) |
| `lightningcss` | MPL-2.0 | <https://github.com/parcel-bundler/lightningcss> | web-dev (Next.js CSS pipeline) |
| `lightningcss-darwin-arm64` *(platform-conditional)* | MPL-2.0 | <https://github.com/parcel-bundler/lightningcss> | web-dev |
| `dompurify` | MPL-2.0 OR Apache-2.0 — Harness elects Apache-2.0 | <https://github.com/cure53/DOMPurify> | web-dev (HTML sanitisation) |
...
cd ../web-dev && npx --yes license-checker-rseidelsohn \
  --csv --excludePrivatePackages > /tmp/web-dev-licenses.csv
...
awk -F'","' 'NR>1 && $2 !~ /^MIT$/ && $2 !~ /^ISC$/ \
  ...
  /tmp/middleware-licenses.csv /tmp/web-dev-licenses.csv
```
