...
describe('agent-reference / Toolkit query_notes_by_person (OB-29-4)', () => {
  ...
  beforeEach(() => {
    records = [
      {
        id: 'n1',
        title: 'Gespräch mit Marcel Wege',
        body: 'Marcel Wege hat Theme F gut umgesetzt.',
        createdAt: '2026-05-01T10:00:00.000Z',
      },
      {
        id: 'n2',
        title: 'Kaffee mit Marcel Müller',
        body: 'Marcel Müller hatte Feedback zur Roadmap.',
