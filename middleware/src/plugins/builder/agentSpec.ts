...
const knownTemplates = new Set<string>(['agent-integration']);
...
const AgentTemplateSchema = z.string().refine((val) => knownTemplates.has(val), {
...
export const AgentSpecSchema = z
  .object({
    ...
    // web-dev embeds the URL as an iframe on the store-detail page once
