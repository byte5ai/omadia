 ...
 *   - "Person:Marcel" / "Person:Anna Müller" → Person-Entity
 *   - "Topic:ThemeF" / "#ThemeG" / "#topic-name" → Topic-Entity
 *
 * Pre-OB-29-3-Caveat: bei Ambiguität (z.B. nur "Marcel" ohne Prefix)
...
export interface ExtractedFact {
  /** Free-form fact summary, e.g. "Person:marcel mentioned in note". */
