 ...
 *   1. Plain question with a German full name (Marcel-Wege smoke).
...
export const NER_FEW_SHOT: ReadonlyArray<{ user: string; assistant: string }> = [
  {
    user: 'Wann hat Marcel Wege Urlaub beantragt?',
    assistant: '{"hits":[{"type":"pii.name","value":"Marcel Wege","start":10,"end":21,"confidence":0.96}]}',
  },
  {
    user:
      'Mitarbeiter-Liste:\n' +
