  ...
  return (
    <div className="space-y-8">
      ...
      {/* Teams sections (epic #860, wave W2a). This component is the single
          composition point for them, so the sibling Teams units extend one
          file instead of racing over the page shell. The assignment panel
          fetches its own read model by slug and disables what the platform
          cannot do, so it is safe to mount before an identity exists. */}
